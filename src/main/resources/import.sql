-- Building
insert into building(id, address) values(1, 'Adresa 174c')

--Apartment
insert into apartment(id, number, building_id) values(1, 1, 1)
insert into apartment(id, number, building_id) values(2, 2, 1)
insert into apartment(id, number, building_id) values(3, 3, 1)
insert into apartment(id, number, building_id) values(4, 4, 1)
...
insert into tenant(id, first_name, last_name, apartment_id) values(2, 'Luka', 'Maletin', 3)
...
insert into tenant(id, first_name, last_name, apartment_id) values(4, 'Aleksandar', 'Nikolic', 4)
...
insert into tenant(id, first_name, last_name, apartment_id) values(8, 'Petar', 'Petrovic', 1)
insert into user_role(user_id, authority) values(8, 'TENANT')
insert into user_role(user_id, authority) values(8, 'SUPERVISOR')
update building set supervisor_id = 8 where id = 1;
...
insert into malfunction(id, description, report_date, building_id, creator_id, work_area, assignee_id) values(1, 'desc', '2017-09-09', 1, 2, 'WATER', 8)
insert into comment(id, content, malfunction_id, user_id, date) values(1, 'some text', 1, 4, '2017-09-09')
insert into comment(id, content, malfunction_id, user_id, date) values(2, 'some text', 1, 3, '2017-09-09')
...
-- Survey
insert into survey(id, name, expiration_date, building_id) values (1, 'Some important survey', to_date('02-02-2018', 'DD-MM-YYYY'), 1)
