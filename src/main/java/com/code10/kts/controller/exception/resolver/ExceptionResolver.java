package com.code10.kts.controller.exception.resolver;
...
import com.code10.kts.model.dto.ErrorResponse;
...
public class ExceptionResolver {
    ...
    public ResponseEntity constraintViolationException() {
        return new ResponseEntity<>(new ErrorResponse("Database constraints violated!"), HttpStatus.BAD_REQUEST);
    }
}
